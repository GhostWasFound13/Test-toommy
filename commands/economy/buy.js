...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];10000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];9999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];25000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];24999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$onlyIf[$getGlobalUserVar[Wallet]>2499;**You dont have enough $getVar[symbol]**]
...
$setGlobalUserVar[cash;$sub[$getGlobalUserVar[Wallet];2500]]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];2500]]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];2000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];1999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[cash];$multi[$message[2];5000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];4999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**
$else
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];7500]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];7499];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];15000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];14999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
$else
$if[$message[1]==income]
$thumbnail[1;$userAvatar[$clientid]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];749];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
$else
$if[$message[1]==daily]
$thumbnail[1;$userAvatar[$clientid]]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];1500]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];1499];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
$else
$if[$message[1]==cring]
$thumbnail[1;$userAvatar[$clientid]]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet]500]]
...
$onlyIf[$getGlobalUserVar[Wallet]>499;**You dont have enough $getVar[symbol]**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];1000]]
...
$onlyIf[$getGlobalUserVar[Wallet]>999;**You dont have enough $getVar[symbol]**]
...
$onlyIf[$getGlobalUserVar[Wallet]>1499;**You dont have enough $getVar[symbol]**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];5000]]
...
$onlyIf[$getGlobalUserVar[Wallet]>4999;**You dont have enough $getVar[symbol]**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];10000]]
...
$onlyIf[$getGlobalUserVar[Wallet]>9999;**You dont have enough $getVar[symbol]**]
$else
$if[$message[1]==fring]
$thumbnail[1;$userAvatar[$clientid]]
$color[1;$getVar[embed_color]]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];15000]]
...
$onlyIf[$getGlobalUserVar[Wallet]>14999;**You dont have enough $getVar[symbol]**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];4000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];3999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];6000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];5999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];8000]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];7999];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];50]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];49];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
...
$setGlobalUserVar[gems;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];100]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];99];**You dont have enough $getVar[gem]**]
$onlyIf[$message[2]>0;**please specify an amount**]
$else
...
$setGlobalUserVar[Wallet;$sub[$getGlobalUserVar[Wallet];$multi[$message[2];500]]]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];499];**You dont have enough $getVar[symbol]**]
$onlyIf[$message[2]>0;**please specify an amount**]
$else
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];4];**You dont have enough $getVar[xpsymbol]**]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];49];**You dont have enough $getVar[xpsymbol]**]
...
$onlyIf[$getGlobalUserVar[Wallet]>$multi[$message[2];9];**You dont have enough $getVar[xpsymbol]**]
...
please contact my ower** \`$userTag[$botownerid]\` **If you have any questions. or come to my [support server](https://discord.gg/5QvnaCutrC)**}}]`}